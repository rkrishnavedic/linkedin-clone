...
const Widgets = ()=>{
    ...
    return(
        <div className="widgets">
            <div className="widgets-music">
                <iframe style={{borderRadius:'10px'}} src="https://open.spotify.com/embed/playlist/7DABXCuuPXgzogqy3OJIgH" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
            </div>
